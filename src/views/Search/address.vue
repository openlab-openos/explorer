                ...
                <card class="md-3 ">
                    <card-body class="card-bodys">
                        <table v-if="this.card"
                            ...
                            <tbody v-for="(item, index) in this.card.value[0] == null ? 1 : this.card.value"
                                :key="index">
                                <tr>
                                    <td>Address</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"> {{ this.card.value[index] == null ? '0' : item.space }}
                                        byte(s)</td>
                                </tr>
                                <tr>
                                    <td>Assigned Program Id</td>
                                    <td class="text-end text-theme" style="cursor: pointer"
                                        @click="exexutable(item.owner)">
                                        {{ item.executable ? 'Native Loader' : ' System Program' }}</td>
                                </tr>
                                <tr>
                                    <td>Executable</td>
                                    <td class="text-end"> {{ this.card.value[index] == null ? 'NO' : (item.executable ?
                                        'YES' : 'NO') }}
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="(item, index) in historyData" :key="index">
                                            <td class="text-theme" style="width: 70%;cursor: pointer"
                                                @click="pubbtx(item.signature)">
                                                {{ item.signature }}
                                            </td>
                                            <td class="text-theme" style="width: 10%;cursor: pointer"
                                                @click="slot(item.slot)">
                                                {{ come(item.slot) }}
                                            </td>
                                            <td style="width: 10%;">
