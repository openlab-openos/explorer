  ...
  <div style="width: 100%">
    ...
    <table v-if="blockType">
      ...
      <tbody>
        ...
        <tr>
          <td>Last Slot</td>
          <td class="text-end text-theme" style="cursor: pointer" @click="blockSkip(lastBlock)"> <count-up duration="3"
              :startVal="lastBlock" :end-val="lastBlock"></count-up> </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="text-end text-theme" style="cursor: pointer" v-if="epochrequest.epoch == epoch"> Epoch in progress
          </td>
