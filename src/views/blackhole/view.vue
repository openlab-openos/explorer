                ...
                <card-body class="card-bodys">
                    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
                        <el-tab-pane :label="$t('navigation.transactions')"name="first">
                            <history-view :url="url"  v-if="activeName == 'first' " ></history-view>
                        </el-tab-pane>
...
import ruruView from '../../components/address/rurn.vue';
...
const url = ref("HoLENeLJxfUiCZv3fiU7JEXJ4NjjksdUeFYEQ5umqVWq");
const card_data = ref([]);
