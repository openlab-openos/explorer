            ...
            <card-body class="card-bodys">
                ...
                <table class="w-100 mb-0 small align-middle table table-striped table-borderless mb-2px small">
                    <tbody>
                        ...
                        <!-- 数据列表 -->
                        <tr v-for="item in paginatedHistoryData" :key="item">
                            <td class="text-theme">
                                <div style="display: flex;">
                                    <div style="width: 24px;height: 24px; overflow: hidden; " class="marginRight8">
                                        <img :src="item.image_url"
                                            style=" width: 100%; height: 100%; object-fit: cover;object-position: center;border-radius: 100%;"
                                            @error="item.image_url = defaultImage" height="24" alt="">
                                    </div>
                                    <text style="cursor: pointer;display: flex;align-items: center;"
                                        @click="pubbleys(item.address)">
...
<script setup>
import { tokenList } from "./Program.js";
