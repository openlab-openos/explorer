...
export function tokenList(page) {
    return new Promise((resolve, reject) => {
        ...
        axios.get(UtlDevnetType ? `https://open.openverse.live/api/tokens?site=openverse&is_all=1&page=${page}&page_size=200` : `https://test-open.openverse.live/api/tokens?site=openverse&is_all=1&page=${page}&page_size=200`, {
