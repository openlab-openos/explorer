...
function isProductionDomains() {
  ...
  console.log(
    "0099",
    !hostname.startsWith("test.") && hostname.startsWith("test-devnet.")
  );
...
const selsetClick = (index: number) => {
  ...
  console.log(selectData.value[i].requestType == "Test");
  ...
  if (selectData.value[i].requestType == "Test") {
    ...
    sessionStorage.setItem("ArchiveType", selectData.value[i].ArchiveType);
    ...
    let ArchiveType = sessionStorage.getItem("ArchiveType");
    // sessionStorage.setItem("urlType", selectData.value[i].requestType);
    console.log("UtlDevnetTypes", UtlDevnetTypes);
    console.log(urlType == selectData.value[i].requestType || !urlType);
    if (
      ArchiveType == "Devnet" &&
      selectData.value[i].ArchiveType != "Devnet"
    ) {
      sessionStorage.setItem("urlType", selectData.value[i].requestType);
      sessionStorage.setItem("ArchiveType", selectData.value[i].ArchiveType);
      setTimeout(() => {
    ...
    } else if (urlType == selectData.value[i].requestType || !urlType) {
      sessionStorage.setItem("urlType", selectData.value[i].requestType);
      sessionStorage.setItem("ArchiveType", selectData.value[i].ArchiveType);
      setTimeout(() => {
        window.location.reload();
