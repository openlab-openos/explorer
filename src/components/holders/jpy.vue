    ...
    <card class="mb-3" style="height: 175px">
      <card-body>
        <div class="d-flex fw-bold small mb-3">
          <span class="flex-grow-1"> {{ $t("holder.title3") }}</span>
        </div>
        <div class="row align-items-center mb-2" style="height: 30px">
          ...
          <div
            ...
            "
          >
            <img :src="jpyImage" width="60" height="60" alt="" />
          </div>
        </div>
...
import jpyImage from '../../assets/holders/JPY.png';
  ...
  watchEffect(async () => {
    ...
    info.value = [
      ...
      },
      {
        ...
        text: come(smartFormatNumber(data.value.supply / 10 ** data.value.decimals)),
      },
      {
