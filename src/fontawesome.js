...
import { library } from '@fortawesome/fontawesome-svg-core';
import { FontAwesomeIcon } from '@fortawesome/vue-fontawesome';
import { faChartPie, faCheckCircle, faQuestionCircle, faExchangeAlt, faAdjust, faStopCircle, faHourglass, faDollarSign, faDatabase, faCubes, faEuroSign, faWonSign, faYenSign, faMoneyBillAlt } from '@fortawesome/free-solid-svg-icons';
...
library.add(faChevronUp, farHdd, farHandPointUp, faCheckCircle, faQuestionCircle);
export { FontAwesomeIcon };
