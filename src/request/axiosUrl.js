...
const ArchiveUrl = ArchiveType == 'Archive2' ? 'https://archive2.openverse.network/': ( ArchiveType == 'RPC' ? 'https://rpc.openverse.network/' : 'https://api.mainnet.openverse.network/');
// const ArchiveUrl = ArchiveType == 'Archive2' ? 'https://archive2.openverse.network/': 'https://api.mainnet.openverse.network/';
