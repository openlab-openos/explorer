          ...
          <card-body class="card-bodys">
            <table v-if="this.card"
              ...
              <tbody v-if="historyData">
                ...
                <tr>
                  <td>Result</td>
                  <td class="text-end" :style="{ 'color': card.value[0].err == null ? '#1BE17E' : 'red' }">{{
                    card.value[0].err == null ? 'Success' : 'Failed' }}</td>
                </tr>
                <tr>
                  <td>Timestamp</td>
                ...
                <tbody>
                  ...
                  <tr v-for="item, index in historyData.transaction.message.accountKeys" :key="index">
                    ...
                    <td v-if="historyData.meta.postBalances[index]">
                      {{ come(toFexedStake(historyData.meta.postBalances[index] - historyData.meta.preBalances[index]))
                      }}
                    </td>
                    <td v-if="historyData.meta.postBalances[index]">
